...
public abstract class IMultiblockPart extends TileEntity {
	 ...
	 */
	public abstract MultiblockMasterBase getMultiblockMaster();
	 ...
	 */
	public abstract void onAttached(MultiblockMasterBase newController);
	 ...
	 */
	public abstract void onDetached(MultiblockMasterBase multiblockController);
	 ...
	 * @see #onDetached(MultiblockMasterBase)
	 ...
	 */
	public abstract void onOrphaned(MultiblockMasterBase oldController, int oldControllerSize, int newControllerSize);
	 ...
	 */
	public abstract Class<? extends MultiblockMasterBase> getMultiblockMasterType();
	 ...
	 */
	public abstract void onAssimilated(MultiblockMasterBase newController);
	 ...
	 */
	public abstract void onMachineAssembled(MultiblockMasterBase multiblockControllerBase);
	 ...
	 */
	public abstract Set<MultiblockMasterBase> attachToNeighbors();
